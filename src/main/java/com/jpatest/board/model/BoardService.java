...
import com.jpatest.exception.CustomException;
import com.jpatest.exception.ErrorCode;
import com.jpatest.paging.CommonParams;
import com.jpatest.paging.Pagination;
...
public class BoardService {
    ...
    public Long save(final BoardRequestDto params) {
        return boardRepository.save(params.toEntity()).getId();
    }
